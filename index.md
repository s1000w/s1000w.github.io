...
12. [개발 작업 일정(12주)](#개발-작업-일정12주)  
13. [주차별 개발 내용(2차시)](#주차별-개발-내용2차시)  
  12-1. [1주차](#1주차)  
...
8.구조물 교단의 공격 스킬 스프라이트 제작 >> 50%  
9.배경 이미지 제작 >> 시간이 부족하면 현상태 유지   
10.시작 화면 UI 제작 (버튼, 교단 심볼 등)  
11.웨이브 수 증가 및 웨이브당 적군 수 증가  
